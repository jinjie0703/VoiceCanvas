...
* **[Zod](https://zod.dev/)**: TypeScript-first 的 Schema 声明与静态类型推断验证库。
* **[Axios](https://axios-http.com/)**: 基于 Promise 的网络请求库，用于处理部分 HTTP 接口交互。
...
* **[ModelScope / 阿里云百炼](https://help.aliyun.com/zh/dashscope/)**: 提供了强大的核心推理大语言模型用于意图解析与坐标计算，以及多模态视觉模型用于空间感知与图像理解。
